...
export default function DeveloperProfilePage() {
  ...
  // This would be the actual logged-in user's ID from a session
  const loggedInUserId = allUsers.find(u => u.email.includes('dev@gmail.com'))?.id || "1";

  const developer = allUsers.find(d => d.id === profileId && d.role === 'Developer');
