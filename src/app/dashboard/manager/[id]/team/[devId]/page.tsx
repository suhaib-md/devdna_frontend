...
export default function ManagerDeveloperProfilePage() {
  const params = useParams();
  
  const managerId = params.id as string;
  const developerId = params.devId as string;
  
  const developer = allUsers.find(d => d.id === developerId);
                ...
                <CardHeader className="flex flex-col md:flex-row items-start md:items-center gap-4">
                    ...
                    <div className="flex-grow">
                        ...
                        <div className="mt-4 flex flex-col md:flex-row items-start md:items-center gap-4">
                            <div className="flex flex-col">
                                <span className='text-sm text-muted-foreground flex items-center gap-1.5'><Codepen className="h-3.5 w-3.5" /> Top Skills</span>
