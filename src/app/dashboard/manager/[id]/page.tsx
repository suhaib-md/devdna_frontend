                 ...
                 <Card>
                    ...
                    <CardContent>
                        <p>Create a new project to get started.</p>
                         <Link href={`/dashboard/manager/${managerId}/create-project`}>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        <Link href={`/dashboard/manager/${managerId}/analytics`} className='block hover:bg-neutral-950/50 p-2 rounded-lg'>
                             ...
                             <div className="pt-4">
                                <Link href={`/dashboard/manager/${managerId}/daily-status`}>
