        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
          {features.map((feature, index) => (
            <TiltedCard key={index}>
              <div className="bg-neutral-950 border border-neutral-800 group-hover:border-cyan-400/50 group-hover:bg-neutral-900 transition-all duration-300 h-full rounded-lg p-6 flex flex-col items-center text-center">
