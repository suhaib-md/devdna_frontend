            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <div className="flex items-center gap-6">
                        <a 
                            href="#" 
                            className="flex items-center justify-center h-10 w-10 rounded-full bg-neutral-900/50 border border-neutral-800/50 text-neutral-400 hover:text-primary hover:border-primary/30 hover:bg-neutral-800/50 transition-all duration-300"
